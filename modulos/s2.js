...
const flowS2Descripciones = addKeyword(['1']).addAnswer([
    ...
    'https://m.ncr.com/infocenter/index?page=content&id=PR2539&viewlocale=en_US#sensor \n',
...
const flowS2Diagnostico = addKeyword(['2']).addAnswer([
    ...
    'https://m.ncr.com/resources/sites/OKM/content/live/PROCEDURE/10000/PR10114/en_US/urn_kid_ncr_moid_46d43c8b-97ee-4e59-a1ed-e9ae05fab7c9.mp4 \n',
    ...
    'https://m.ncr.com/infocenter/index?page=content&id=PR2539&viewlocale=en_US#Jam \n',
...
const flowS2Reemplazos = addKeyword(['3']).addAnswer([
    ...
    'https://m.ncr.com/resources/sites/OKM/content/live/PROCEDURE/10000/PR10115/en_US/urn_kid_ncr_moid_7ff4768c-2c2b-49e2-84a5-f14ab8e28389.mp4 \n',
...
//dividir en secciones: Descripcion/diagramas , troubleshooting ms mdata, reemplazo de partes
const flowS2Manual = addKeyword(['2']).addAnswer([
    '📂 Estás en  Financial - Bancos / Módulos / S2 /👉 *Guías de servicio técnico S2* \n',


    '*1* - Descripción general del módulo S2',
    ...
    delay: 1000
}, null, [flowS2Descripciones, flowS2Diagnostico, flowS2Reemplazos])
